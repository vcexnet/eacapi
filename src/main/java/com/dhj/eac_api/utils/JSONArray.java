...
import com.dhj.eac_api.exception.JSONPointerException;
...
public class JSONArray implements Iterable<Object> {
    ...
    public JSONArray(Collection<?> collection) {
        if (collection == null) {
            ...
            for (Object o : collection) {
                this.myArrayList.add(org.json.JSONObject.wrap(o));
            }
        }
    }
    ...
    public JSONArray(Object array) throws JSONException {
        ...
        if (array.getClass().isArray()) {
            ...
            for (int i = 0; i < length; i += 1) {
                this.put(org.json.JSONObject.wrap(Array.get(array, i)));
            }
        } else {
    ...
    public <E extends Enum<E>> E getEnum(Class<E> clazz, int index) throws JSONException {
        ...
        if (val == null) {
            ...
            throw new JSONException("JSONArray[" + index + "] is not an enum of type "
                    + org.json.JSONObject.quote(clazz.getSimpleName()) + ".");
        }
        return val;
    }
    ...
    public org.json.JSONObject optJSONObject(int index) {
        Object o = this.opt(index);
        return o instanceof org.json.JSONObject ? (org.json.JSONObject) o : null;
    }
    ...
    public String optString(int index, String defaultValue) {
        Object object = this.opt(index);
        return org.json.JSONObject.NULL.equals(object) ? defaultValue : object
                .toString();
    }
    ...
    public JSONArray put(Map<?, ?> value) {
        return this.put(new org.json.JSONObject(value));
    }
    ...
    public List<Object> toList() {
        ...
        for (Object element : this.myArrayList) {
            if (element == null || org.json.JSONObject.NULL.equals(element)) {
                results.add(null);
            } else if (element instanceof JSONArray) {
                results.add(((JSONArray) element).toList());
            } else if (element instanceof org.json.JSONObject) {
